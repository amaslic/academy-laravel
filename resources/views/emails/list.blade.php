...
<style type="text/css">
    ...
    .unSubContent a:visited { color:  #E15A00; text-decoration:underline; font-weight:normal;}
    .unSubContent a:focus   { color:  #E15A00; text-decoration:underline; font-weight:normal;}
    .unSubContent a:hover   { color:  #E15A00; text-decoration:underline; font-weight:normal;}
    .unSubContent a:link   { color: #E15A00 ; text-decoration:underline; font-weight:normal;}
    .unSubContent a .yshortcuts   { color: #E15A00; text-decoration:underline; font-weight:normal;}
    ...
    a:visited { color: #E15A00; text-decoration:none;}
    a:focus   { color: #E15A00; text-decoration:none;}
    a:hover   { color: #E15A00; text-decoration:none;}
    a:link   { color: #E15A00; text-decoration:none;}
    a .yshortcuts   { color:  #E15A00 ; text-decoration:none;}
    ...
    @media only screen and (max-width: 550px), screen and (max-device-width: 550px) {
        ...
        body[yahoo] .button a {background-color: #E15A00; padding: 15px 15px 13px!important;}
        body[yahoo] .unsubscribe {display: block; margin-top: 20px; padding: 10px 50px; background: rgb(255,172,43); border-radius: 5px; text-decoration: none!important; font-weight: normal;}
    }
